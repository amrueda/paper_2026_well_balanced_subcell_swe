...
include("subcell_fluxes_wintermeyer.jl")
...
polydeg = 3
volume_flux = (flux_wintermeyer_etal, flux_nonconservative_wintermeyer_etal_local_jump)
surface_flux = (FluxPlusDissipation(flux_wintermeyer_etal, DissipationLaxFriedrichsEntropyVariables()), flux_nonconservative_wintermeyer_etal_local_jump)
...
save_solution = SaveSolutionCallback(dt = 1.0,
                                     ...
                                     output_directory = joinpath(@__DIR__, "results_wintermeyer_jump"))
